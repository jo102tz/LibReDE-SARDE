 ...
 *
 */
public class EstimationEntry extends LogEntry {
	 ...
	 *            The error of the specific estimation.
	 */
	public EstimationEntry(long starttimems, long endtimems, String estimate, String error) {
		super(starttimems, endtimems, OperationType.ESTIMATION);
		this.error = error;
