...
public class FileTraceConfigurationItemProvider extends TraceConfigurationItemProvider {
	...
	public String getText(Object object) {
		Aggregation labelValue = ((FileTraceConfiguration)object).getAggregation();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_FileTraceConfiguration_type") :
			getString("_UI_FileTraceConfiguration_type") + " " + label;
	}
