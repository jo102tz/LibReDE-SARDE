...
/**
 * This is the item provider adapter for a {@link tools.descartes.librede.metrics.Metric} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetricItemProvider 
	...
	protected void addDimensionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Metric_dimension_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Metric_dimension_feature", "_UI_Metric_type"),
	...
	/**
	 * This adds a property descriptor for the Allowed Aggregations feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAllowedAggregationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Metric_allowedAggregations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Metric_allowedAggregations_feature", "_UI_Metric_type"),
				 MetricsPackage.Literals.METRIC__ALLOWED_AGGREGATIONS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
