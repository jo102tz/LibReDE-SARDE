...
/**
 * This is the item provider adapter for a {@link tools.descartes.librede.units.Dimension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DimensionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dimension_baseUnit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dimension_baseUnit_feature", "_UI_Dimension_type"),
				 UnitsPackage.Literals.DIMENSION__BASE_UNIT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UnitsPackage.Literals.DIMENSION__UNITS);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(UnitsPackage.Literals.DIMENSION__UNITS,
				 UnitsFactory.eINSTANCE.createUnit()));
	}
