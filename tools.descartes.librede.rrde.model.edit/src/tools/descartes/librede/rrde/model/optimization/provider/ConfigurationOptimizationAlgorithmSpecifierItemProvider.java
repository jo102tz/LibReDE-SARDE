...
/**
 * This is the item provider adapter for a {@link tools.descartes.librede.rrde.model.optimization.ConfigurationOptimizationAlgorithmSpecifier} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationOptimizationAlgorithmSpecifierItemProvider 
	 ...
	 * @generated
	 */
	public ConfigurationOptimizationAlgorithmSpecifierItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ConfigurationOptimizationAlgorithmSpecifier)object).getAlgorithmName();
		return label == null || label.length() == 0 ?
			getString("_UI_ConfigurationOptimizationAlgorithmSpecifier_type") :
			getString("_UI_ConfigurationOptimizationAlgorithmSpecifier_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConfigurationOptimizationAlgorithmSpecifier.class)) {
