...
/**
 * This is the item provider adapter for a {@link tools.descartes.librede.rrde.optimization.StepSize} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StepSizeItemProvider 
	 ...
	 * @generated
	 */
	public StepSizeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StepSize"));
	}
	...
	public String getText(Object object) {
		Object labelValue = ((StepSize)object).getLowerBound();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_StepSize_type") :
			getString("_UI_StepSize_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StepSize.class)) {
