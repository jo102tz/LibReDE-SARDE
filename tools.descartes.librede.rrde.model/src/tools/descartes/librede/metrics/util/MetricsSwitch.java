...
public class MetricsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MetricsPackage.METRICS_REPOSITORY: {
				MetricsRepository metricsRepository = (MetricsRepository)theEObject;
				T result = caseMetricsRepository(metricsRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseMetricsRepository(MetricsRepository object) {
		return null;
	}
