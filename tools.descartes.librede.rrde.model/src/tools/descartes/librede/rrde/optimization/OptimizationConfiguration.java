 ...
 * <ul>
 *   <li>{@link tools.descartes.librede.rrde.optimization.OptimizationConfiguration#getContainsOf <em>Contains Of</em>}</li>
 * </ul>
 * </p>
 *
 * @see tools.descartes.librede.rrde.optimization.OptimizationPackage#getOptimizationConfiguration()
 * @model
 * @generated
 */
public interface OptimizationConfiguration extends EObject {
	 ...
	 * The list contents are of type {@link tools.descartes.librede.rrde.optimization.RunCall}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see tools.descartes.librede.rrde.optimization.OptimizationPackage#getOptimizationConfiguration_ContainsOf()
