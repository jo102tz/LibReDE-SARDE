...
public class OptimizationPackageImpl extends EPackageImpl implements OptimizationPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getIterativeParameterOptimizerSpecifier_NumberOfSplits(), ecorePackage.getEInt(), "numberOfSplits", "3", 1, 1, IterativeParameterOptimizerSpecifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIterativeParameterOptimizerSpecifier_NumberOfExplorations(), ecorePackage.getEInt(), "numberOfExplorations", "3", 1, 1, IterativeParameterOptimizerSpecifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIterativeParameterOptimizerSpecifier_NumberOfIterations(), ecorePackage.getEInt(), "numberOfIterations", "3", 1, 1, IterativeParameterOptimizerSpecifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
