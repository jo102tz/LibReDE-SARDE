...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Abstract Iterative Parameter Optimizer</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link tools.descartes.librede.rrde.optimization.AbstractIterativeParameterOptimizer#getNumberOfSplits <em>Number Of Splits</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.optimization.AbstractIterativeParameterOptimizer#getNumberOfExplorations <em>Number Of Explorations</em>}</li>
 * </ul>
 * </p>
 *
...
public interface AbstractIterativeParameterOptimizer extends IConfigurationOptimizationAlgorithm {
	 ...
	 * @see tools.descartes.librede.rrde.optimization.OptimizationPackage#getAbstractIterativeParameterOptimizer_NumberOfSplits()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.optimization.AbstractIterativeParameterOptimizer#getNumberOfSplits <em>Number Of Splits</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tools.descartes.librede.rrde.optimization.OptimizationPackage#getAbstractIterativeParameterOptimizer_NumberOfExplorations()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.optimization.AbstractIterativeParameterOptimizer#getNumberOfExplorations <em>Number Of Explorations</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
...
} // AbstractIterativeParameterOptimizer
