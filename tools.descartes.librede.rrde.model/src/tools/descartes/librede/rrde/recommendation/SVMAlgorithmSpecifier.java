...
public interface SVMAlgorithmSpecifier extends RecommendationAlgorithmSpecifier {
	 ...
	 * @see tools.descartes.librede.rrde.recommendation.RecommendationPackage#getSVMAlgorithmSpecifier_GaussianSigma()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.recommendation.SVMAlgorithmSpecifier#getGaussianSigma <em>Gaussian Sigma</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tools.descartes.librede.rrde.recommendation.RecommendationPackage#getSVMAlgorithmSpecifier_SoftMarginPenalty()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.recommendation.SVMAlgorithmSpecifier#getSoftMarginPenalty <em>Soft Margin Penalty</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
