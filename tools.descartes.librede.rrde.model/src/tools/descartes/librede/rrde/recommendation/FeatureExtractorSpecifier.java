 ...
 *   <li>{@link tools.descartes.librede.rrde.recommendation.FeatureExtractorSpecifier#getAggregation <em>Aggregation</em>}</li>
 * </ul>
 * </p>
 *
...
public interface FeatureExtractorSpecifier extends EObject {
	 ...
	 * @see tools.descartes.librede.rrde.recommendation.RecommendationPackage#getFeatureExtractorSpecifier_Aggregation()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.recommendation.FeatureExtractorSpecifier#getAggregation <em>Aggregation</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
