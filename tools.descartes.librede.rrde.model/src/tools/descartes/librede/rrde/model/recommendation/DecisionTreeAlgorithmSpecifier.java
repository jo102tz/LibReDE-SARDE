 ...
 * </p>
 * <ul>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.DecisionTreeAlgorithmSpecifier#getMaximumNumberOfNodes <em>Maximum Number Of Nodes</em>}</li>
 * </ul>
 *
 * @see tools.descartes.librede.rrde.model.recommendation.RecommendationPackage#getDecisionTreeAlgorithmSpecifier()
 * @model
 * @generated
 */
public interface DecisionTreeAlgorithmSpecifier extends RecommendationAlgorithmSpecifier {
	 ...
	 * @see tools.descartes.librede.rrde.model.recommendation.RecommendationPackage#getDecisionTreeAlgorithmSpecifier_MaximumNumberOfNodes()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.recommendation.DecisionTreeAlgorithmSpecifier#getMaximumNumberOfNodes <em>Maximum Number Of Nodes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
