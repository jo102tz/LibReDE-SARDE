 ...
 * </p>
 * <ul>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getNumberOfRessources <em>Number Of Ressources</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getNumberOfWorkloadClasses <em>Number Of Workload Classes</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getVarianceInflationFactor <em>Variance Inflation Factor</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getUtilizationStatistics <em>Utilization Statistics</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getResponseTimeStatistics <em>Response Time Statistics</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getArrivalRateStatistics <em>Arrival Rate Statistics</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getResponseArrivalCorrelation <em>Response Arrival Correlation</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getResponseArrivalCovariance <em>Response Arrival Covariance</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getUtilizationResponseCorrelation <em>Utilization Response Correlation</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getUtilizationResponseCovariance <em>Utilization Response Covariance</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getUtilizationArrivalCorrelation <em>Utilization Arrival Correlation</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getUtilizationArrivalCovariance <em>Utilization Arrival Covariance</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getIntraUtilizationCorrelation <em>Intra Utilization Correlation</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getIntraUtilizationCovariance <em>Intra Utilization Covariance</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getIntraResponseTimeCorrelation <em>Intra Response Time Correlation</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getIntraResponseTimeCovariance <em>Intra Response Time Covariance</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getIntraArrivalRateCorrelation <em>Intra Arrival Rate Correlation</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.FeatureVectorImpl#getIntraArrivalRateCovariance <em>Intra Arrival Rate Covariance</em>}</li>
 * </ul>
 *
 * @generated
 */
