 ...
 * </p>
 * <ul>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getN <em>N</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getArithmeticMean <em>Arithmetic Mean</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getGeometricMean <em>Geometric Mean</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getQuadraticMean <em>Quadratic Mean</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getKurtosis <em>Kurtosis</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getSkewness <em>Skewness</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getTenthpercentile <em>Tenthpercentile</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getNinetiethpercentile <em>Ninetiethpercentile</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getAutocorrelation <em>Autocorrelation</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.recommendation.impl.StatisticalFeaturesImpl#getIsNormalDistributed <em>Is Normal Distributed</em>}</li>
 * </ul>
 *
 * @generated
 */
