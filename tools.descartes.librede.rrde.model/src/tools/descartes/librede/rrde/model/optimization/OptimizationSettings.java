 ...
 * </p>
 * <ul>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.OptimizationSettings#getValidator <em>Validator</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.OptimizationSettings#getParametersToOptimize <em>Parameters To Optimize</em>}</li>
 * </ul>
 *
 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getOptimizationSettings()
 * @model
 * @generated
 */
public interface OptimizationSettings extends EObject {
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getOptimizationSettings_Validator()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.OptimizationSettings#getValidator <em>Validator</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link tools.descartes.librede.rrde.model.optimization.IOptimizableParameter}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getOptimizationSettings_ParametersToOptimize()
