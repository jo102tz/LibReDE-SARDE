 ...
 * </p>
 * <ul>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.DataExportSpecifier#getOutputDirectory <em>Output Directory</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.DataExportSpecifier#getStepSize <em>Step Size</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.DataExportSpecifier#isMultidimensional <em>Multidimensional</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.DataExportSpecifier#isSplitConfigurations <em>Split Configurations</em>}</li>
 * </ul>
 *
 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getDataExportSpecifier()
 * @model
 * @generated
 */
public interface DataExportSpecifier extends ConfigurationOptimizationAlgorithmSpecifier {
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getDataExportSpecifier_OutputDirectory()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.DataExportSpecifier#getOutputDirectory <em>Output Directory</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getDataExportSpecifier_StepSize()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.DataExportSpecifier#getStepSize <em>Step Size</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getDataExportSpecifier_Multidimensional()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.DataExportSpecifier#isMultidimensional <em>Multidimensional</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getDataExportSpecifier_SplitConfigurations()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.DataExportSpecifier#isSplitConfigurations <em>Split Configurations</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
