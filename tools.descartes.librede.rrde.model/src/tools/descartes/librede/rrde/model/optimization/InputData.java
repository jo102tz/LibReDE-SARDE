 ...
 * </p>
 * <ul>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.InputData#getInput <em>Input</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.InputData#getWorkloadDescription <em>Workload Description</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.InputData#getRootFolder <em>Root Folder</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.InputData#isMultiFolderStructures <em>Multi Folder Structures</em>}</li>
 * </ul>
 *
 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getInputData()
 * @model
 * @generated
 */
public interface InputData extends EObject {
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getInputData_Input()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.InputData#getInput <em>Input</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getInputData_WorkloadDescription()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.InputData#getWorkloadDescription <em>Workload Description</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getInputData_RootFolder()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.InputData#getRootFolder <em>Root Folder</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getInputData_MultiFolderStructures()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.InputData#isMultiFolderStructures <em>Multi Folder Structures</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
