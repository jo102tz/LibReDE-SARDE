 ...
 * </p>
 * <ul>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.StepSizeRelWindow#getProductMaxValue <em>Product Max Value</em>}</li>
 * </ul>
 *
 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getStepSizeRelWindow()
 * @model
 * @generated
 */
public interface StepSizeRelWindow extends StepSize {
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getStepSizeRelWindow_ProductMaxValue()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.StepSizeRelWindow#getProductMaxValue <em>Product Max Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
