 ...
 * </p>
 * <ul>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.LocalSearchSpecifier#getTolerance <em>Tolerance</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.LocalSearchSpecifier#getMaximumNumberOfSteps <em>Maximum Number Of Steps</em>}</li>
 *   <li>{@link tools.descartes.librede.rrde.model.optimization.LocalSearchSpecifier#getStepSize <em>Step Size</em>}</li>
 * </ul>
 *
 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getLocalSearchSpecifier()
 * @model
 * @generated
 */
public interface LocalSearchSpecifier extends ConfigurationOptimizationAlgorithmSpecifier {
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getLocalSearchSpecifier_Tolerance()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.LocalSearchSpecifier#getTolerance <em>Tolerance</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getLocalSearchSpecifier_MaximumNumberOfSteps()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.LocalSearchSpecifier#getMaximumNumberOfSteps <em>Maximum Number Of Steps</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tools.descartes.librede.rrde.model.optimization.OptimizationPackage#getLocalSearchSpecifier_StepSize()
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.model.optimization.LocalSearchSpecifier#getStepSize <em>Step Size</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
