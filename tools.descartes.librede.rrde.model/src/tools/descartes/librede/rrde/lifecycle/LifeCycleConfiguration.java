 ...
 *   <li>{@link tools.descartes.librede.rrde.lifecycle.LifeCycleConfiguration#getEstimationLoopTime <em>Estimation Loop Time</em>}</li>
 * </ul>
 *
...
public interface LifeCycleConfiguration extends EObject {
	 ...
	 * @see tools.descartes.librede.rrde.lifecycle.LifecyclePackage#getLifeCycleConfiguration_EstimationLoopTime()
	 * @model default="-1" dataType="org.eclipse.emf.ecore.xml.type.Long" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.rrde.lifecycle.LifeCycleConfiguration#getEstimationLoopTime <em>Estimation Loop Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
