...
public interface FileTraceConfiguration extends TraceConfiguration {
	 ...
	 * @see #setFile(String)
	 * @see tools.descartes.librede.configuration.ConfigurationPackage#getFileTraceConfiguration_File()
	 * @model required="true"
	 * @generated
	 */
	String getFile();
	...
	/**
	 * Sets the value of the '{@link tools.descartes.librede.configuration.FileTraceConfiguration#getFile <em>File</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
