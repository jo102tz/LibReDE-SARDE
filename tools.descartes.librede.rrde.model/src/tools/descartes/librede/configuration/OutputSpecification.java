 ...
 * <ul>
 *   <li>{@link tools.descartes.librede.configuration.OutputSpecification#getExporters <em>Exporters</em>}</li>
 * </ul>
 * </p>
 *
 * @see tools.descartes.librede.configuration.ConfigurationPackage#getOutputSpecification()
 * @model
 * @generated
 */
public interface OutputSpecification extends EObject {
	 ...
	 * The list contents are of type {@link tools.descartes.librede.configuration.ExporterConfiguration}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see tools.descartes.librede.configuration.ConfigurationPackage#getOutputSpecification_Exporters()
