...
import optimization.optimization.IAlgorithm;
import optimization.optimization.InputData;
import optimization.optimization.OptimizationConfiguration;
import optimization.optimization.OptimizationFactory;
import optimization.optimization.OptimizationPackage;
import optimization.optimization.RunCall;
import optimization.optimization.Settings;
...
public class OptimizationPackageImpl extends EPackageImpl implements OptimizationPackage {
	 ...
	 * @see optimization.optimization.OptimizationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static OptimizationPackage init() {
		...
		optimization.impl.OptimizationPackageImpl theOptimizationPackage_1 = (optimization.impl.OptimizationPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(optimization.OptimizationPackage.eNS_URI) instanceof optimization.impl.OptimizationPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(optimization.OptimizationPackage.eNS_URI) : optimization.OptimizationPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		optimization.OptimizationPackage theOptimizationPackage_1 = (optimization.OptimizationPackage)EPackage.Registry.INSTANCE.getEPackage(optimization.OptimizationPackage.eNS_URI);
		...
		hillClimbingSettingsEClass.getESuperTypes().add(theOptimizationPackage_1.getSettings());
		...
		initEReference(getOptimizationConfiguration_ContainsOf(), theOptimizationPackage_1.getRunCall(), null, "containsOf", null, 0, -1, OptimizationConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRunCall_Executes(), theOptimizationPackage_1.getIAlgorithm(), null, "executes", null, 1, 1, RunCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRunCall_ExecutesOn(), theOptimizationPackage_1.getInputData(), null, "executesOn", null, 1, -1, RunCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRunCall_SpecifiedBy(), theOptimizationPackage_1.getSettings(), null, "specifiedBy", null, 1, 1, RunCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
