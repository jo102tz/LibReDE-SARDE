 ...
 * <ul>
 *   <li>{@link optimization.optimization.Settings#getTimeOut <em>Time Out</em>}</li>
 * </ul>
 * </p>
 *
 * @see optimization.optimization.OptimizationPackage#getSettings()
 * @model abstract="true"
 * @generated
 */
public interface Settings extends EObject {
	 ...
	 * @see #setTimeOut(long)
	 * @see optimization.optimization.OptimizationPackage#getSettings_TimeOut()
	 * @model default="-1"
	 * @generated
	 */
	long getTimeOut();
	...
	/**
	 * Sets the value of the '{@link optimization.optimization.Settings#getTimeOut <em>Time Out</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
