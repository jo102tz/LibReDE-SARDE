...
public class RunOptimizationAction extends Action {
	...
	public RunOptimizationAction(LifeCycleConfiguration conf) {
		super();
		this.conf = conf;
		setToolTipText("Run Optimization...");
	...
	@Override
	public void run() {
		Job estimationJob = new Job("Running Optimization...") {
	...
	private void runEstimation(IProgressMonitor monitor) {
		...
		//OptimizationPlugin.runConfigurationOptimization(conf.getOptimizationConfiguration());
