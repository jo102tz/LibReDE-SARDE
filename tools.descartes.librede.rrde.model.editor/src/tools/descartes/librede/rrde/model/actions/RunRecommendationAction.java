 ...
 */
package tools.descartes.librede.rrde.model.actions;
...
import tools.descartes.librede.rrde.recommendation.Plugin;



public class RunRecommendationAction extends Action {

	private static final String CONSOLE_NAME = "RRDEConsole";
	
	private LifeCycleConfiguration conf;
	
	
	public RunRecommendationAction(LifeCycleConfiguration conf) {
		super();
		this.conf = conf;
		setToolTipText("Run Recommendation...");
	...
	@Override
	public void run() {
		Job estimationJob = new Job("Running Recommendation...") {
	...
	private void runEstimation(IProgressMonitor monitor) {
		...
		//Plugin.loadAndTrainAlgorithm(conf.getRecommendationConfiguration());
