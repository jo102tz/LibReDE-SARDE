...
public abstract class AbstractLifecycleConfigurationFormPage extends FormPage {
	...
	public AbstractLifecycleConfigurationFormPage(LifecycleEditor editor,
			String id, String title, AdapterFactoryEditingDomain editingDomain, LifeCycleConfiguration model) {
		super(editor, id, title);
		this.editingDomain = editingDomain;
		this.model = model;
	}

	public LifeCycleConfiguration getModel() {
		return model;
	}
	...
	public AdapterFactory getAdapterFactory() {
		return ((LifecycleEditor)getEditor()).getAdapterFactory();
	}
	
	public LifecycleEditor getLifecycleEditor() {
		return (LifecycleEditor)getEditor();
	}
}
