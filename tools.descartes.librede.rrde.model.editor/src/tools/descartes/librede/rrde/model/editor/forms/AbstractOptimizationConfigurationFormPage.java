...
public abstract class AbstractOptimizationConfigurationFormPage extends FormPage {
	...
	private OptimizationConfiguration model;
	private AdapterFactoryEditingDomain editingDomain;

	public AbstractOptimizationConfigurationFormPage(OptimizationEditor editor,
			String id, String title, AdapterFactoryEditingDomain editingDomain, OptimizationConfiguration model) {
		super(editor, id, title);
		this.editingDomain = editingDomain;
		this.model = model;
	}

	public OptimizationConfiguration getModel() {
		return model;
	}
	...
	public AdapterFactory getAdapterFactory() {
		return ((OptimizationEditor)getEditor()).getAdapterFactory();
	}
	
	public OptimizationEditor getOptimizationEditor() {
		return (OptimizationEditor)getEditor();
	}
}
