...
public abstract class AbstractRecommendationConfigurationFormPage extends FormPage {
	...
	public static abstract class EObjectEditingSupport extends
		...
		protected boolean canEdit(Object element) {
			if (element instanceof EObject) {
				return ((EObject)element).eClass().getEAllStructuralFeatures().contains(attribute);
			}
			return false;
		}
	...
	private RecommendationTrainingConfiguration model;
	private AdapterFactoryEditingDomain editingDomain;

	public AbstractRecommendationConfigurationFormPage(RecommendationEditor editor,
			String id, String title, AdapterFactoryEditingDomain editingDomain, RecommendationTrainingConfiguration model) {
		super(editor, id, title);
		this.editingDomain = editingDomain;
		this.model = model;
	}

	public RecommendationTrainingConfiguration getModel() {
		return model;
	}
	...
	public AdapterFactory getAdapterFactory() {
		return ((RecommendationEditor)getEditor()).getAdapterFactory();
	}
	
	public RecommendationEditor getRecommendationEditor() {
		return (RecommendationEditor)getEditor();
	}
}
