...
public class MasterDetailsFormPage extends
		AbstractLifecycleConfigurationFormPage {
	 ...
	 * @param title
	 */
	public MasterDetailsFormPage(LifecycleEditor editor, String id,
			String title, String icon,
			AdapterFactoryEditingDomain editingDomain,
			LifeCycleConfiguration model, AbstractMasterBlock masterBlock) {
