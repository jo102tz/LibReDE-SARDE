...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>recommendation</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RecommendationExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(RecommendationPackage.eNS_URI, 
			 RecommendationPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.recommendation"));
				RecommendationTrainingConfiguration root = RecommendationFactory.eINSTANCE.createRecommendationTrainingConfiguration();
