/**
 */
package tools.descartes.librede.metrics.tests;
 ...
 * @generated
 */
public class MetricsRepositoryTest extends TestCase {
	 ...
	 * @generated
	 */
	protected MetricsRepository fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(MetricsRepositoryTest.class);
	}
	 ...
	 * @generated
	 */
	public MetricsRepositoryTest(String name) {
		super(name);
	}
	 ...
	 * @generated
	 */
	protected void setFixture(MetricsRepository fixture) {
	 ...
	 * @generated
	 */
	protected MetricsRepository getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(MetricsFactory.eINSTANCE.createMetricsRepository());
	}
